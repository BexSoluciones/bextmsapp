...
class ChargerStatus {
  ...
  final _methodChannel = const MethodChannel('com.bexsoluciones.charger_status:method_channel');
  final _eventChannel = const EventChannel("com.bexsoluciones.charger_status/event_channel");
