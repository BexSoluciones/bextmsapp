...
class DeliveryDescription extends StatefulWidget {
  final WorkAdditional data;


  const DeliveryDescription({Key? key, required this.data}) : super(key: key);

  @override
  State<DeliveryDescription> createState() => _DeliveryDescriptionState();
}

class _DeliveryDescriptionState extends State<DeliveryDescription> {
