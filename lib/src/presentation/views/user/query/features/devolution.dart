...
class _DevolutionQueryViewState extends State<DevolutionQueryView>
    with FormatNumber {
  @override
            ...
            child: BlocBuilder<QueryCubit, QueryState>(
              builder: (_, state) {
                switch (state.runtimeType) {
                  ...
                  case QuerySuccess:
                    return _buildHome(state.rejects, state.totalReject!);
                  case QueryFailed:
                    return Center(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  ...
                  child:
                      ItemRespawn(data: data[index], reason: 'Devoluciones '),
                );
              },
            )),
        const Spacer(),
