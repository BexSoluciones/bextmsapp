...
class ItemDevolution extends StatelessWidget  with FormatNumber {
  ItemDevolution({Key? key, required this.data }) : super(key: key);
    ...
    return Material(
      child: Ink(
        ...
        child: ListTile(
          ...
          //   children: [
          //     Text(
          //       'Estado: ${data.status == 'partial' ? 'Parcial' : 'Devolucion Total'}',
