...
class RespawnDescription extends StatefulWidget {
  final WorkAdditional data;


  const RespawnDescription({Key? key, required this.data}) : super(key: key);

  @override
  State<RespawnDescription> createState() => _RespawnDescriptionState();
}

class _RespawnDescriptionState extends State<RespawnDescription> {
